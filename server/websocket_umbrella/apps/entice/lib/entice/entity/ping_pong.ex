defmodule Entice.Entity.PingPong do
  ...
  def register(entity), do: Entity.put_behaviour(entity, PingPong.Behaviour, [])

  def unregister(entity), do: Entity.remove_behaviour(entity, PingPong.Behaviour)
  ...
  defmodule Behaviour do
    ...
    def handle_call(:ping_pong_ping, entity), do: {:ok, :pong, entity}
  end
end
