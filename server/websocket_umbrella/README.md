...
- [Websocket.Umbrella](#websocketumbrella)
  - [本工程](#本工程)
    - [断线重连详细逻辑](#断线重连详细逻辑)
    - [游戏过程中 用户、房间状态的初始化和清除](#游戏过程中-用户房间状态的初始化和清除)
...
### 游戏过程中 用户、房间状态的初始化和清除

如果动作是由用户发出的，那么动作进来的时候就应该更新状态，比如说ready，是由用户发出的，直接对应状态的更新，那么就在user_in的时候更新，如果ready的状态发生了变化还需要做其他的事情，可以在user_out中做，因为这是 该动作引起的变化。
