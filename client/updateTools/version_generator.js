...
// var src = './jsb/';
var src = '../' + game + '/build/jsb-default/';
...
while (i < process.argv.length) {
    ...
    switch (arg) {
        ...
        case '-v':
            ...
            manifest.packageUrl = url + game + '/remote-assets' + '/';
            manifest.remoteManifestUrl = url + game + '/remote-assets' + '/' + 'project.manifest';
            manifest.remoteVersionUrl = url + game + '/remote-assets' + '/' + 'version.manifest';
            manifest.appName = game;// 在manifest文件中加入自定义的字段
            // 本地原生打包版本的目录相对路径
            // src = src + game + '/';
...
copyFile('remote-assets/project.manifest', '../' + game + '/assets/resources/project.manifest', copy);